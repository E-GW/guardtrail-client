...
GuardTrail gives hikers the abilty to track and report adverse trail condition like ice, washouts, and downed trees in real time, giving later hikers a heads-up about what they may encounter. Trail maintenance crews can also use the app to see where hikers have found problems and resolve them.
